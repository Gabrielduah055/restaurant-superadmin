...
import { BillingStatus, Restaurant, RestaurantStatus } from '@core/models/restaurant.model';
import { RestaurantService } from '@core/services/restaurant.service';

@Component({ selector: 'app-restaurant-list', imports: [DatePipe, FormsModule, RouterLink], templateUrl: './restaurant-list.component.html' })
  ...
  get filteredRestaurants(): Restaurant[] {
    ...
    return this.restaurants.filter((restaurant) => {
      ...
      return matchesSearch &&
        (this.selectedStatus === 'all' || restaurant.status === this.selectedStatus) &&
        (this.selectedBillingStatus === 'all' || restaurant.billingStatus === this.selectedBillingStatus);
    });
  }
